...
#ifndef typedef_parser_h
#define typedef_parser_h
...
*/               
   ...
   // Defined constants for the node names (uppercase) ...
	...
	// AST Action Mode. 
      ...
      class typedef_parser : public typedef_lexer, public Symtab, public AST
		{
		public:
		...
		private:
         ...
         static int     S_stack[];				// State stack.
			...
			static uchar   Rr[];			// Reduction matrix row (base).
